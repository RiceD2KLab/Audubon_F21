...
def crop_img_trainer(csv_file, crop_height, crop_width, sliding_size_x, sliding_size_y, output_dir, class_map={},
                     overlap=0.8, annot_file_ext='csv', file_dict={}, compute_sliding_size=False):
    #
    """
...
def crop_dataset_trainer(data_dir, output_dir, annot_file_ext='csv', class_map={}, crop_height=640, crop_width=640,
                         sliding_size_x=440, sliding_size_y=440, compute_sliding_size=False):
    """
    Function description.
    INPUTS:
