...
def split_img_annos(img_files, anno_files, frac, seed=None):
    ...
    Args:
        ...
        frac (tuple of floats): A tuple of three floats that specifies the fraction of data
            to be used for training, testing, and validation.
        seed (int or None, optional): A random seed to use for shuffling the files. Defaults to None.
