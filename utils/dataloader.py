...
def register_datasets(data_dirs,img_ext):
  """
  ...
  for data_dir in data_dirs:
    ...
    DatasetCatalog.register(f"birds_species_{d}", lambda d=d: get_bird_species_dicts(data_dir,
                                                                                  ["Brown Pelican", "Laughing Gull", "Mixed Tern"],
                                                                                  img_ext))
    ...
    MetadataCatalog.get(f"birds_species_{d}").set(thing_classes=["Brown Pelican", "Laughing Gull", "Mixed Tern", "Unknown Bird"])