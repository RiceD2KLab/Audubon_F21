...
def concat_frames(file_names):
    ...
    Args:
        file_names: A list of CSV file names to read and concatenate.
...
def get_file_names(path, extension):
    ...
    Args:
        ...
        extension: The file extension to match. For example, '.csv' for annotations or '.jpg' for images.
...
def split_img_annos(img_files, anno_files, frac, seed=None):
    ...
    Args:
        img_files: A list of image file paths.
        anno_files: A list of annotation file paths.
