...
def crop_img(csv_file, crop_height, crop_width, output_dir, img_ext, class_map = {}, overlap=0.2, annot_file_ext='csv', file_dict={}):
    """
...
def crop_dataset_img_only_hank(data_dir, img_ext, output_dir, crop_height=640, crop_width=640, sliding_size=400):
    """
    This function crops image dataset with adjustable sliding size. Bounding boxes are not cropped alongside images.
    Function is to be used during final pipeline stage for prediction
    INPUTS:
