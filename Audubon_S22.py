...
data_dir = 'C://Users\\VelocityUser\Documents\D2K TDS D\Images'  # data directory folder
...
cfg.MODEL.WEIGHTS = 'C://Users\\VelocityUser\\Documents\\Training_models\\04_25_10class_aug_T2\\faster_rcnn_R_50_FPN_1x-20220426-100044\\model_final.pth'
...
output_df.to_csv('D2K_TDS_D_10_species_T2.csv')
#
# # #######################################################################################################################
