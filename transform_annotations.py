...
from config import DATA_PATH, PLOTS_PATH, DESC_MAPPING, ON_DELETE
...
write_csv(OLD_CSV_PATH, NEW_CSV_PATH, DESC_MAPPING, ON_DELETE)
write_csv(TILED_OLD_CSV_PATH, TILED_NEW_CSV_PATH, DESC_MAPPING, ON_DELETE)


def add_class_id_and_data_exploration(new_path, title, plot_path=None):
...
add_class_id_and_data_exploration(NEW_CSV_PATH, 'histogram of bird species (original images)', PLOTS_PATH)
add_class_id_and_data_exploration(TILED_NEW_CSV_PATH, 'histogram of bird species (tiled images)', PLOTS_PATH)
